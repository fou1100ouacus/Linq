...
namespace Sharedd
{
    public static class QuestionBank
    {
        ...
        public static IEnumerable<Question> Randomize(int count)
        {
            ...
            return AllShufled.Take(count).ToList();
        }
        ...
        public static void Toquize(this IEnumerable<Question>questions)
        {
        ...
        private static List<Question>AllShufled=>All.OrderBy(x=>random.Next()).ToList();
